...
import ViewTeamAdminCard from "../ViewTeamAdminCard/ViewTeamAdminCard";
    ...
    const fetchTeamMembers = async () => {
      try {
        ...
        const response = await axios.get(
          "http://16.171.8.84:8085/api/get/all/admin/auth",
          {
            headers: {
        ...
        setTeamAdmins(response.data.data);
        setLoading(false);
        ...
        <div className="team_member_search_heading">
          <div className="team-search-container">
            <input
              ...
              style={{ padding: "10px 35px", width: "500px" }}
            />
